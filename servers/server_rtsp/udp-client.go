...
func (c *UDPClient) SetupAudio() (err error) {
	...
	if err := c.AConn.SetReadBuffer(networkBuffer); err != nil {
		beego.Debug("udp client audio conn set read buffer error, %v", err)
	}
	if err := c.AConn.SetWriteBuffer(networkBuffer); err != nil {
		beego.Debug("udp client audio conn set write buffer error, %v", err)
	}
	...
	if err := c.AControlConn.SetReadBuffer(networkBuffer); err != nil {
		beego.Debug("udp client audio control conn set read buffer error, %v", err)
	}
	if err := c.AControlConn.SetWriteBuffer(networkBuffer); err != nil {
		beego.Debug("udp client audio control conn set write buffer error, %v", err)
	}
	return
}
...
func (c *UDPClient) SetupVideo() (err error) {
	...
	if err := c.VConn.SetReadBuffer(networkBuffer); err != nil {
		beego.Debug("udp client video conn set read buffer error, %v", err)
	}
	if err := c.VConn.SetWriteBuffer(networkBuffer); err != nil {
		beego.Debug("udp client video conn set write buffer error, %v", err)
	}
	...
	if err := c.VControlConn.SetReadBuffer(networkBuffer); err != nil {
		beego.Debug("udp client video control conn set read buffer error, %v", err)
	}
	if err := c.VControlConn.SetWriteBuffer(networkBuffer); err != nil {
		beego.Debug("udp client video control conn set write buffer error, %v", err)
	}
	return
}
...
func (c *UDPClient) SendRTP(pack *RTPPack) (err error) {
	...
	// beego.Debug("udp client write [%d/%d]", n, pack.Buffer.Len())
